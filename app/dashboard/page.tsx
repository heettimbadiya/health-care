      ...
      <div className="bg-gradient-to-br from-primary-600 to-secondary-600 rounded-xl shadow-lg p-8 text-white mb-8">
        <div className="max-w-2xl">
          ...
          <p className="text-primary-100 mb-6">
            Manage your patient incentives, track performance, and generate comprehensive reports
            all in one place. Get started by exploring the navigation menu on the left.
          </p>
          <div className="flex flex-wrap gap-4">
            ...
            <button className="bg-primary-700 text-white px-6 py-2 rounded-lg font-semibold hover:bg-primary-800 transition-colors border border-primary-500">
              Manage Patients
            </button>
          </div>
        </div>
