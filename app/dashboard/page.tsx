...
function DashboardContent() {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden">
      {/* Top Navbar */}
      <nav className="bg-white border-b border-gray-200 shadow-sm z-50 flex-shrink-0">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <aside
          className={`
            fixed inset-y-16 left-0 z-40 w-64 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 lg:inset-y-0 h-[calc(100vh-4rem)] lg:h-full
        ...
        >
          <div className="flex flex-col h-full">
            <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
              <a
                href="#"
                className="flex items-center px-4 py-3 text-sm font-medium text-white bg-primary-600 rounded-lg hover:bg-primary-700 transition-colors"
              >
                <svg
        ...
        <main className="flex-1 overflow-y-auto">
          <div className="py-8 px-4 sm:px-6 lg:px-8">
            ...
            {/* Welcome Card */}
            <div className="bg-gradient-to-br from-primary-600 to-secondary-600 rounded-xl shadow-lg p-8 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <button className="bg-white border border-gray-200 rounded-lg p-6 text-left hover:shadow-md transition-shadow">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">Manage Incentives</p>
                      <p className="text-sm text-gray-500">Update incentive programs</p>
                    </div>
                  </div>
                </button>
              </div>
